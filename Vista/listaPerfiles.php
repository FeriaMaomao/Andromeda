    ...
    <?php } ?>
      ...
      <form class="navbar-form navbar-left" action="">
        <div class="form-group">
          <input type="text" class="form-control" placeholder="Buscar Perfiles" name="caja_busqueda" id="caja_busqueda">
        </div>
    </form>
    </ul>
    <br>
...
<div class="container">
  ...
  <br>
  <?php if($_SESSION['rol']==1) { ?>
  <a href="../Vista/RegistroPerfiles.php" target="_self"><button title="Registrar Perfiles" type="button" class="btn btn-primary"><span class="icon-plus"></span> <span class="icon-login"></span></button></a><?php } ?>
  <br>
<?php
  if ($msj==1)
  echo '<h3 style="color:green" align="center">Se ha Agregado el Perfil Correctamente</h3>';
  if ($msj==2)
  echo '<h3 style="color:red" align="center">Problemas al Agregar Perfil, Por favor revise los datos</h3>';
  if ($msj==3)
  echo '<h3 style="color:green" align="center">Se ha Modificado el Perfil Correctamente</h3>';
  if ($msj==4)
  echo '<h3 style="color:red" align="center">Problemas al Modificar Perfil, Por favor revise</h3>';
  if ($msj==5)
  echo '<h3 style="color:green" align="center">Se ha Eliminado el Perfil Correctamente</h3>';
  if ($msj==6)
  echo '<h3 style="color:red" align="center">Problemas al Eliminar Perfil, Por favor revise</h3>';
  ?>
  <br>
