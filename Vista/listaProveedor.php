    ...
    <?php } ?>
      ...
      <form class="navbar-form navbar-left" action="">
        <div class="form-group">
          <input type="text" class="form-control" placeholder="Buscar Proveedor" name="caja_busqueda" id="caja_busqueda">
        </div>
    </form>
    </ul>
    <br>
...
<div class="container">
  ...
  <br>
  <?php if($_SESSION['rol']==1) { ?>
	<a href="../Vista/Registroproveedor.php" target="_self"><button title="Registrar Proveedor" type="button" class="btn btn-primary"><span class="icon-plus"> </span><span class="icon-man"></span></button></a><?php } ?>
  <br>
    <?php
  if ($msj==1)
